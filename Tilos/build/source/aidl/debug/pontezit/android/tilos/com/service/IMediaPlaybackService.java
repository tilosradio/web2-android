...
public static abstract class Stub extends android.os.Binder implements pontezit.android.tilos.com.service.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "pontezit.android.tilos.com.service.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an pontezit.android.tilos.com.service.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static pontezit.android.tilos.com.service.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof pontezit.android.tilos.com.service.IMediaPlaybackService))) {
return ((pontezit.android.tilos.com.service.IMediaPlaybackService)iin);
}
return new pontezit.android.tilos.com.service.IMediaPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements pontezit.android.tilos.com.service.IMediaPlaybackService
{
...
@Override public int getTrackId() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_getTrackId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getMediaUri = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getTrackNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_setSleepTimerMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getSleepTimerMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
...
public int getTrackId() throws android.os.RemoteException;
